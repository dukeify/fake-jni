...
namespace FakeJni {
 NativeInterface::NativeInterface(): JNINativeInterface_() {
  reserved0 = reserved1 = reserved2 = reserved3 = nullptr;
  GetVersion = [](JNIEnv *env) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetVersion\n");
#endif
  ...
  DefineClass = [](JNIEnv *env, const char *str, jobject obj, const jbyte *bytes, jsize size) -> jclass {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::DefineClass\n");
#endif
  ...
  FindClass = [](JNIEnv *env, const char *str) -> jclass {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::FindClass\n");
#endif
  ...
  FromReflectedMethod = [](JNIEnv *env, jobject obj) -> jmethodID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::FromReflectedMethod\n");
#endif
  ...
  FromReflectedField = [](JNIEnv *env, jobject obj) -> jfieldID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::FromReflectedField\n");
#endif
  ...
  ToReflectedMethod = [](JNIEnv *env, jclass clazz, jmethodID jmid, jboolean b) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ToReflectedMethod\n");
#endif
  ...
  GetSuperclass = [](JNIEnv *env, jclass clazz) -> jclass {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetSuperclass\n");
#endif
  ...
  IsAssignableFrom = [](JNIEnv *env, jclass clazz1, jclass clazz2) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::IsAssignableFrom\n");
#endif
  ...
  ToReflectedField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jboolean b) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ToReflectedField\n");
#endif
  ...
  Throw = [](JNIEnv *env, jthrowable t) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::Throw\n");
#endif
   return ni->throw_(t);
  };
  ThrowNew = [](JNIEnv *env, jclass clazz, const char *str) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ThrowNew\n");
#endif
  ...
  ExceptionOccurred = [](JNIEnv *env) -> jthrowable {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ExceptionOccurred\n");
#endif
  ...
  ExceptionDescribe = [](JNIEnv *env) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ExceptionDescribe\n");
#endif
  ...
  ExceptionClear = [](JNIEnv *env) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ExceptionClear\n");
#endif
   ni->exceptionClear();
  };
  FatalError = [](JNIEnv *env, const char *str) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::FatalError\n");
#endif
   ni->fatalError(str);
  };
  PushLocalFrame = [](JNIEnv *env, jint i) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::PushLocalFrame\n");
#endif
  ...
  PopLocalFrame = [](JNIEnv *env, jobject obj) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::PopLocalFrame\n");
#endif
  ...
  NewGlobalRef = [](JNIEnv *env, jobject obj) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewGlobalRef\n");
#endif
  ...
  DeleteGlobalRef = [](JNIEnv *env, jobject obj) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::DeleteGlobalRef\n");
#endif
  ...
  DeleteLocalRef = [](JNIEnv *env, jobject obj) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::DeleteLocalRef\n");
#endif
  ...
  IsSameObject = [](JNIEnv *env, jobject obj1, jobject obj2) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::IsSameObject\n");
#endif
  ...
  NewLocalRef = [](JNIEnv *env, jobject obj) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewLocalRef\n");
#endif
  ...
  EnsureLocalCapacity = [](JNIEnv *env, jint i) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::EnsureLocalCapacity\n");
#endif
  ...
  AllocObject = [](JNIEnv *env, jclass clazz) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::AllocObject\n");
#endif
  ...
  NewObjectV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewObjectV\n");
#endif
  ...
  NewObjectA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *value) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewObjectA\n");
#endif
  ...
  GetObjectClass = [](JNIEnv *env, jobject obj) -> jclass {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetObjectClass\n");
#endif
  ...
  IsInstanceOf = [](JNIEnv *env, jobject obj, jclass clazz) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::IsInstanceOf\n");
#endif
  ...
  GetMethodID = [](JNIEnv *env, jclass clazz, const char *str1, const char *str2) -> jmethodID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetMethodID\n");
#endif
  ...
  CallObjectMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallObjectMethodV\n");
#endif
  ...
  CallObjectMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallObjectMethodA\n");
#endif
  ...
  CallBooleanMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallBooleanMethodV\n");
#endif
  ...
  CallBooleanMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallBooleanMethodA\n");
#endif
  ...
  CallByteMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallByteMethodV\n");
#endif
  ...
  CallByteMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallByteMethodA\n");
#endif
  ...
  CallCharMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallCharMethodV\n");
#endif
  ...
  CallCharMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallCharMethodA\n");
#endif
  ...
  CallShortMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallShortMethodV\n");
#endif
  ...
  CallShortMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallShortMethodA\n");
#endif
  ...
  CallIntMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallIntMethodV\n");
#endif
  ...
  CallIntMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallIntMethodA\n");
#endif
  ...
  CallLongMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallLongMethodV\n");
#endif
  ...
  CallLongMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallLongMethodA\n");
#endif
  ...
  CallFloatMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallFloatMethodV\n");
#endif
  ...
  CallFloatMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallFloatMethodA\n");
#endif
  ...
  CallDoubleMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallDoubleMethodV\n");
#endif
  ...
  CallDoubleMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallDoubleMethodA\n");
#endif
  ...
  CallVoidMethodV = [](JNIEnv *env, jobject obj, jmethodID jmid, va_list l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallVoidMethodV\n");
#endif
  ...
  CallVoidMethodA = [](JNIEnv *env, jobject obj, jmethodID jmid, const jvalue *val) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallVoidMethodA\n");
#endif
  ...
  CallNonvirtualObjectMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualObjectMethodV\n");
#endif
  ...
  CallNonvirtualObjectMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid,
   ...
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualObjectMethodA\n");
#endif
  ...
  CallNonvirtualBooleanMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualBooleanMethodV\n");
#endif
  ...
  CallNonvirtualBooleanMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid,
   ...
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualBooleanMethodA\n");
#endif
  ...
  CallNonvirtualByteMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualByteMethodV\n");
#endif
  ...
  CallNonvirtualByteMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, const jvalue *val) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualByteMethodA\n");
#endif
  ...
  CallNonvirtualCharMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualCharMethodV\n");
#endif
  ...
  CallNonvirtualCharMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, const jvalue *val) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualCharMethodA\n");
#endif
  ...
  CallNonvirtualShortMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualShortMethodV\n");
#endif
  ...
  CallNonvirtualShortMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid,
   ...
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualShortMethodA\n");
#endif
  ...
  CallNonvirtualIntMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualIntMethodV\n");
#endif
  ...
  CallNonvirtualIntMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, const jvalue *val) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualIntMethodA\n");
#endif
  ...
  CallNonvirtualLongMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualLongMethodV\n");
#endif
  ...
  CallNonvirtualLongMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, const jvalue *val) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualLongMethodA\n");
#endif
  ...
  CallNonvirtualFloatMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualFloatMethodV\n");
#endif
  ...
  CallNonvirtualFloatMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid,
   ...
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualFloatMethodA\n");
#endif
  ...
  CallNonvirtualDoubleMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualDoubleMethodV\n");
#endif
  ...
  CallNonvirtualDoubleMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid,
   ...
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualDoubleMethodA\n");
#endif
  ...
  CallNonvirtualVoidMethodV = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, va_list l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualVoidMethodV\n");
#endif
  ...
  CallNonvirtualVoidMethodA = [](JNIEnv *env, jobject obj, jclass clazz, jmethodID jmid, const jvalue *val) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallNonvirtualVoidMethodA\n");
#endif
  ...
  GetFieldID = [](JNIEnv *env, jclass clazz, const char *str1, const char *str2) -> jfieldID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetFieldID\n");
#endif
  ...
  GetObjectField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetObjectField\n");
#endif
  ...
  GetBooleanField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetBooleanField\n");
#endif
  ...
  GetByteField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetByteField\n");
#endif
  ...
  GetCharField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetCharField\n");
#endif
  ...
  GetShortField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetShortField\n");
#endif
  ...
  GetIntField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetIntField\n");
#endif
  ...
  GetLongField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetLongField\n");
#endif
  ...
  GetFloatField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetFloatField\n");
#endif
  ...
  GetDoubleField = [](JNIEnv *env, jobject obj, jfieldID jfid) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetDoubleField\n");
#endif
  ...
  SetObjectField = [](JNIEnv *env, jobject obj1, jfieldID jfid, jobject obj2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetObjectField\n");
#endif
  ...
  SetBooleanField = [](JNIEnv *env, jobject obj, jfieldID jfid, jboolean b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetBooleanField\n");
#endif
  ...
  SetByteField = [](JNIEnv *env, jobject obj, jfieldID jfid, jbyte b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetByteField\n");
#endif
  ...
  SetCharField = [](JNIEnv *env, jobject obj, jfieldID jfid, jchar c) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetCharField\n");
#endif
  ...
  SetShortField = [](JNIEnv *env, jobject obj, jfieldID jfid, jshort s) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetShortField\n");
#endif
  ...
  SetIntField = [](JNIEnv *env, jobject obj, jfieldID jfid, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetIntField\n");
#endif
  ...
  SetLongField = [](JNIEnv *env, jobject obj, jfieldID jfid, jlong l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetLongField\n");
#endif
  ...
  SetFloatField = [](JNIEnv *env, jobject obj, jfieldID jfid, jfloat f) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetFloatField\n");
#endif
  ...
  SetDoubleField = [](JNIEnv *env, jobject obj, jfieldID jfid, jdouble d) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetDoubleField\n");
#endif
  ...
  GetStaticMethodID = [](JNIEnv *env, jclass clazz, const char *str1, const char *str2) -> jmethodID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticMethodID\n");
#endif
  ...
  CallStaticObjectMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticObjectMethodV\n");
#endif
  ...
  CallStaticObjectMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticObjectMethodA\n");
#endif
  ...
  CallStaticBooleanMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticBooleanMethodV\n");
#endif
  ...
  CallStaticBooleanMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticBooleanMethodA\n");
#endif
  ...
  CallStaticByteMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticByteMethodV\n");
#endif
  ...
  CallStaticByteMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticByteMethodA\n");
#endif
  ...
  CallStaticCharMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticCharMethodV\n");
#endif
  ...
  CallStaticCharMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticCharMethodA\n");
#endif
  ...
  CallStaticShortMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticShortMethodV\n");
#endif
  ...
  CallStaticShortMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticShortMethodA\n");
#endif
  ...
  CallStaticIntMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticIntMethodV\n");
#endif
  ...
  CallStaticIntMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticIntMethodA\n");
#endif
  ...
  CallStaticLongMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticLongMethodV\n");
#endif
  ...
  CallStaticLongMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticLongMethodA\n");
#endif
  ...
  CallStaticFloatMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticFloatMethodV\n");
#endif
  ...
  CallStaticFloatMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticFloatMethodA\n");
#endif
  ...
  CallStaticDoubleMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticDoubleMethodV\n");
#endif
  ...
  CallStaticDoubleMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticDoubleMethodA\n");
#endif
  ...
  CallStaticVoidMethodV = [](JNIEnv *env, jclass clazz, jmethodID jmid, va_list l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticVoidMethodV\n");
#endif
  ...
  CallStaticVoidMethodA = [](JNIEnv *env, jclass clazz, jmethodID jmid, const jvalue *val) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::CallStaticVoidMethodA\n");
#endif
  ...
  GetStaticFieldID = [](JNIEnv *env, jclass clazz, const char *str1, const char *str2) -> jfieldID {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticFieldID\n");
#endif
  ...
  GetStaticObjectField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticObjectField\n");
#endif
  ...
  GetStaticBooleanField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticBooleanField\n");
#endif
  ...
  GetStaticByteField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jbyte {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticByteField\n");
#endif
  ...
  GetStaticCharField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jchar {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticCharField\n");
#endif
  ...
  GetStaticShortField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jshort {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticShortField\n");
#endif
  ...
  GetStaticIntField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticIntField\n");
#endif
  ...
  GetStaticLongField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticLongField\n");
#endif
  ...
  GetStaticFloatField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jfloat {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticFloatField\n");
#endif
  ...
  GetStaticDoubleField = [](JNIEnv *env, jclass clazz, jfieldID jfid) -> jdouble {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStaticDoubleField\n");
#endif
  ...
  SetStaticObjectField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jobject obj) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticObjectField\n");
#endif
  ...
  SetStaticBooleanField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jboolean b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticBooleanField\n");
#endif
  ...
  SetStaticByteField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jbyte b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticByteField\n");
#endif
  ...
  SetStaticCharField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jchar c) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticCharField\n");
#endif
  ...
  SetStaticShortField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jshort s) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticShortField\n");
#endif
  ...
  SetStaticIntField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticIntField\n");
#endif
  ...
  SetStaticLongField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jlong l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticLongField\n");
#endif
  ...
  SetStaticFloatField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jfloat f) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticFloatField\n");
#endif
  ...
  SetStaticDoubleField = [](JNIEnv *env, jclass clazz, jfieldID jfid, jdouble d) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetStaticDoubleField\n");
#endif
  ...
  NewString = [](JNIEnv *env, const jchar *str, jsize size) -> jstring {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewString\n");
#endif
  ...
  GetStringLength = [](JNIEnv *env, jstring str) -> jsize {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringLength\n");
#endif
  ...
  GetStringChars = [](JNIEnv *env, jstring str, jboolean *b) -> const jchar * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringChars\n");
#endif
  ...
  ReleaseStringChars = [](JNIEnv *env, jstring str1, const jchar *str2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseStringChars\n");
#endif
  ...
  NewStringUTF = [](JNIEnv *env, const char *str) -> jstring {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewStringUTF\n");
#endif
  ...
  GetStringUTFLength = [](JNIEnv *env, jstring str) -> jsize {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringUTFLength\n");
#endif
  ...
  GetStringUTFChars = [](JNIEnv *env, jstring str, jboolean *b) -> const char * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringUTFChars\n");
#endif
  ...
  ReleaseStringUTFChars = [](JNIEnv *env, jstring str1, const char *str2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseStringUTFChars\n");
#endif
  ...
  GetArrayLength = [](JNIEnv *env, jarray arr) -> jsize {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetArrayLength\n");
#endif
  ...
  NewObjectArray = [](JNIEnv *env, jsize size, jclass clazz, jobject obj) -> jobjectArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewObjectArray\n");
#endif
  ...
  GetObjectArrayElement = [](JNIEnv *env, jobjectArray arr, jsize size) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetObjectArrayElement\n");
#endif
  ...
  SetObjectArrayElement = [](JNIEnv *env, jobjectArray arr, jsize size, jobject obj) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetObjectArrayElement\n");
#endif
  ...
  NewBooleanArray = [](JNIEnv *env, jsize size) -> jbooleanArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewBooleanArray\n");
#endif
  ...
  NewByteArray = [](JNIEnv *env, jsize size) -> jbyteArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewByteArray\n");
#endif
  ...
  NewCharArray = [](JNIEnv *env, jsize size) -> jcharArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewCharArray\n");
#endif
  ...
  NewShortArray = [](JNIEnv *env, jsize size) -> jshortArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewShortArray\n");
#endif
  ...
  NewIntArray = [](JNIEnv *env, jsize size) -> jintArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewIntArray\n");
#endif
  ...
  NewLongArray = [](JNIEnv *env, jsize size) -> jlongArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewLongArray\n");
#endif
  ...
  NewFloatArray = [](JNIEnv *env, jsize size) -> jfloatArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewFloatArray\n");
#endif
  ...
  NewDoubleArray = [](JNIEnv *env, jsize size) -> jdoubleArray {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewDoubleArray\n");
#endif
  ...
  GetBooleanArrayElements = [](JNIEnv *env, jbooleanArray arr, jboolean *b) -> jboolean * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetBooleanArrayElements\n");
#endif
  ...
  GetByteArrayElements = [](JNIEnv *env, jbyteArray arr, jboolean *b) -> jbyte * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetByteArrayElements\n");
#endif
  ...
  GetCharArrayElements = [](JNIEnv *env, jcharArray arr, jboolean *b) -> jchar * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetCharArrayElements\n");
#endif
  ...
  GetShortArrayElements = [](JNIEnv *env, jshortArray arr, jboolean *b) -> jshort * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetShortArrayElements\n");
#endif
  ...
  GetIntArrayElements = [](JNIEnv *env, jintArray arr, jboolean *b) -> jint * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetIntArrayElements\n");
#endif
  ...
  GetLongArrayElements = [](JNIEnv *env, jlongArray arr, jboolean *b) -> jlong * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetLongArrayElements\n");
#endif
  ...
  GetFloatArrayElements = [](JNIEnv *env, jfloatArray arr, jboolean *b) -> jfloat * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetFloatArrayElements\n");
#endif
  ...
  GetDoubleArrayElements = [](JNIEnv *env, jdoubleArray arr, jboolean *b) -> jdouble * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetDoubleArrayElements\n");
#endif
  ...
  ReleaseBooleanArrayElements = [](JNIEnv *env, jbooleanArray arr, jboolean *b, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseBooleanArrayElements\n");
#endif
  ...
  ReleaseByteArrayElements = [](JNIEnv *env, jbyteArray arr, jbyte *b, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseByteArrayElements\n");
#endif
  ...
  ReleaseCharArrayElements = [](JNIEnv *env, jcharArray arr, jchar *c, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseCharArrayElements\n");
#endif
  ...
  ReleaseShortArrayElements = [](JNIEnv *env, jshortArray arr, jshort *s, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseShortArrayElements\n");
#endif
  ...
  ReleaseIntArrayElements = [](JNIEnv *env, jintArray arr, jint *i1, jint i2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseIntArrayElements\n");
#endif
  ...
  ReleaseLongArrayElements = [](JNIEnv *env, jlongArray arr, jlong *l, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseLongArrayElements\n");
#endif
  ...
  ReleaseFloatArrayElements = [](JNIEnv *env, jfloatArray arr, jfloat *f, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseFloatArrayElements\n");
#endif
  ...
  ReleaseDoubleArrayElements = [](JNIEnv *env, jdoubleArray arr, jdouble *d, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseDoubleArrayElements\n");
#endif
  ...
  GetBooleanArrayRegion = [](JNIEnv *env, jbooleanArray arr, jsize i1, jsize i2, jboolean *b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetBooleanArrayRegion\n");
#endif
  ...
  GetByteArrayRegion = [](JNIEnv *env, jbyteArray arr, jsize i1, jsize i2, jbyte *b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetByteArrayRegion\n");
#endif
  ...
  GetCharArrayRegion = [](JNIEnv *env, jcharArray arr, jsize i1, jsize i2, jchar *c) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetCharArrayRegion\n");
#endif
  ...
  GetShortArrayRegion = [](JNIEnv *env, jshortArray arr, jsize i1, jsize i2, jshort *s) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetShortArrayRegion\n");
#endif
  ...
  GetIntArrayRegion = [](JNIEnv *env, jintArray arr, jsize i1, jsize i2, jint *i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetIntArrayRegion\n");
#endif
  ...
  GetLongArrayRegion = [](JNIEnv *env, jlongArray arr, jsize i1, jsize i2, jlong *l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetLongArrayRegion\n");
#endif
  ...
  GetFloatArrayRegion = [](JNIEnv *env, jfloatArray arr, jsize i1, jsize i2, jfloat *f) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetFloatArrayRegion\n");
#endif
  ...
  GetDoubleArrayRegion = [](JNIEnv *env, jdoubleArray arr, jsize i1, jsize i2, jdouble *d) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetDoubleArrayRegion\n");
#endif
  ...
  SetBooleanArrayRegion = [](JNIEnv *env, jbooleanArray arr, jsize i1, jsize i2, const jboolean *b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetBooleanArrayRegion\n");
#endif
  ...
  SetByteArrayRegion = [](JNIEnv *env, jbyteArray arr, jsize i1, jsize i2, const jbyte *b) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetByteArrayRegion\n");
#endif
  ...
  SetCharArrayRegion = [](JNIEnv *env, jcharArray arr, jsize i1, jsize i2, const jchar *c) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetCharArrayRegion\n");
#endif
  ...
  SetShortArrayRegion = [](JNIEnv *env, jshortArray arr, jsize i1, jsize i2, const jshort *s) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetShortArrayRegion\n");
#endif
  ...
  SetIntArrayRegion = [](JNIEnv *env, jintArray arr, jsize i1, jsize i2, const jint *i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetIntArrayRegion\n");
#endif
  ...
  SetLongArrayRegion = [](JNIEnv *env, jlongArray arr, jsize i1, jsize i2, const jlong *l) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetLongArrayRegion\n");
#endif
  ...
  SetFloatArrayRegion = [](JNIEnv *env, jfloatArray arr, jsize i1, jsize i2, const jfloat *f) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetFloatArrayRegion\n");
#endif
  ...
  SetDoubleArrayRegion = [](JNIEnv *env, jdoubleArray arr, jsize i1, jsize i2, const jdouble *d) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::SetDoubleArrayRegion\n");
#endif
  ...
  RegisterNatives = [](JNIEnv *env, jclass clazz, const JNINativeMethod *m, jint i) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::RegisterNatives\n");
#endif
  ...
  UnregisterNatives = [](JNIEnv *env, jclass clazz) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::UnregisterNatives\n");
#endif
  ...
  MonitorEnter = [](JNIEnv *env, jobject obj) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::MonitorEnter\n");
#endif
  ...
  MonitorExit = [](JNIEnv *env, jobject obj) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::MonitorExit\n");
#endif
  ...
  GetJavaVM = [](JNIEnv *env, JavaVM **pvm) -> jint {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetJavaVM\n");
#endif
  ...
  GetStringRegion = [](JNIEnv *env, jstring str1, jsize i1, jsize i2, jchar *str2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringRegion\n");
#endif
  ...
  GetStringUTFRegion = [](JNIEnv *env, jstring str1, jsize i1, jsize i2, char *str2) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringUTFRegion\n");
#endif
  ...
  GetPrimitiveArrayCritical = [](JNIEnv *env, jarray arr, jboolean *b) -> void * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetPrimitiveArrayCritical\n");
#endif
  ...
  ReleasePrimitiveArrayCritical = [](JNIEnv *env, jarray arr, void *carr, jint i) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleasePrimitiveArrayCritical\n");
#endif
  ...
  GetStringCritical = [](JNIEnv *env, jstring str, jboolean *b) -> const jchar * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetStringCritical\n");
#endif
  ...
  ReleaseStringCritical = [](JNIEnv *env, jstring str, const jchar *c) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ReleaseStringCritical\n");
#endif
  ...
  NewWeakGlobalRef = [](JNIEnv *env, jobject obj) -> jweak {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewWeakGlobalRef\n");
#endif
  ...
  DeleteWeakGlobalRef = [](JNIEnv *env, jweak w) -> void {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::DeleteWeakGlobalRef\n");
#endif
  ...
  ExceptionCheck = [](JNIEnv *env) -> jboolean {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::ExceptionCheck\n");
#endif
  ...
  NewDirectByteBuffer = [](JNIEnv *env, void *addr, jlong l) -> jobject {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::NewDirectByteBuffer\n");
#endif
  ...
  GetDirectBufferAddress = [](JNIEnv *env, jobject obj) -> void * {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetDirectBufferAddress\n");
#endif
  ...
  GetDirectBufferCapacity = [](JNIEnv *env, jobject obj) -> jlong {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetDirectBufferCapacity\n");
#endif
  ...
  GetObjectRefType = [](JNIEnv *env, jobject obj) -> jobjectRefType {
   _FETCH_ENV_
#ifdef FAKE_JNI_DEBUG
   fprintf(jenv->getVM()->getLog(), "DEBUG: JNINativeInterface_::GetObjectRefType\n");
#endif
